...
namespace confocal_ui
{
    public partial class FormScanSettings : C1RibbonForm
    {
        ...
        {
            return mScanSettingsVM.Engine.Config.ScanPixelChangeCommand(scanPixel);
        }
        ...
        {
            mScanSettingsVM.Engine.ScannerHeadChangeCommand(rbtnTwoScanners.Checked);
        }
        ...
        {
            mScanSettingsVM.Engine.ScanModeChangeCommand(rbtnGalvano.Checked);
        }
        ...
        {
            if (mScanSettingsVM.Engine.Config.ScanUniDirection.IsEnabled)
            {
                btnUniDirection.Pressed = true;
                return;
            }
            btnBiDirection.Pressed = !btnUniDirection.Pressed;
            mScanSettingsVM.Engine.ScanDirectionChangeCommand(btnUniDirection.Pressed);
        }
        ...
        {
            if (mScanSettingsVM.Engine.Config.ScanBiDirection.IsEnabled)
            {
        ...
        private void ScanPixelDwellChanged(object sender, EventArgs e)
        {
            ...
            mScanSettingsVM.Engine.ScanPixelDwellChangeCommand(model);
        }
        ...
        private void ScanPixelChanged(object sender, EventArgs e)
        {
            ...
            mScanSettingsVM.Engine.ScanPixelChangeCommand(model);
        }
        ...
        {
            mScanSettingsVM.Engine.LineSkipValueChangeCommand((ScanLineSkipModel)cbxLineSkip.SelectedItem);
        }
        ...
        private void ScanPinHoleChanged(object sender, EventArgs e)
        {
            ...
            mScanSettingsVM.Engine.PinHoleSelectChangeCommand((ScanPinHoleModel)cbxPinHoleSelect.SelectedItem);
            this.tbarPinHole.DataBindings.Add("Value", mScanSettingsVM.Engine.Config.SelectedPinHole, "Size");
        }
        ...
        {
            mScanSettingsVM.Engine.Config.FastModeEnabled = rbtnFastMode.Pressed;
            Logger.Info(string.Format("Fast Mode Enabled [{0}].", mScanSettingsVM.Engine.Config.FastModeEnabled));
        }
        ...
        {
            mScanSettingsVM.Engine.LineSkipEnableChangeCommand(chbxLineSkip.Checked);
        }
        ...
        {
            mScanSettingsVM.Engine.PinHoleValueChangeCommand(tbarPinHole.Value);
        }
        ...
        private void ChannelGainChanged(object sender, EventArgs e)
        {
            ...
            mScanSettingsVM.Engine.ChannelGainChangeCommand((int)bar.Tag, bar.Value);
        }
        ...
        {
            InputTrackBar bar = (InputTrackBar)sender;
            mScanSettingsVM.Engine.ChannelOffsetChangeCommand((int)bar.Tag, bar.Value);
        }
        ...
        {
            InputTrackBar bar = (InputTrackBar)sender;
            mScanSettingsVM.Engine.ChannelPowerChangeCommand((int)bar.Tag, bar.Value);
        }
        ...
        {
            InputButton button = (InputButton)sender;
            mScanSettingsVM.Engine.ChannelActivateChangeCommand((int)button.Tag, button.Pressed);
        }
