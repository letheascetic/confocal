...
namespace confocal_core.Common
{
    ...
    public enum API_RETURN_CODE : int
    {
        ...
        API_FAILED = 0x10000000,
        /* error for config */
        API_FAILED_CONFIG_HANDLE_INVALID = 0x10000100,
        API_FAILED_CONFIG_SET_LASER_SWITCH_FAILED,
        API_FAILED_CONFIG_SET_LASER_POWER_FAILED,
        /* error for ats9440 */
        API_FAILED_ATS_HANDLE_INVALID = 0x10000200,
        ...
        /* error for laser */
        API_FAILED_LASER_LOAD_DLL_FAILED = 0x10000400,
        ...
        /* error for ni card */
        API_FAILED_NI_CONFIG_AO_TASK_EXCEPTION = 0x10000800,
